...
_G.lsp_organize_imports_sync = function(bufnr)
  ...
  --buf_set_keymap('n', '<space>o', "<cmd>lua lsp_organize_imports()<CR>", opts)
  --buf_set_keymap('n', '<space>f', "<cmd>lua vim.lsp.buf.formatting_sync(nil, 1000)<CR>", opts)
...
nvim_lsp.diagnosticls.setup {
  on_attach = on_attach,
  filetypes = { 'tsx', 'ts', 'js', 'jsx', 'json', 'css', 'less', 'scss', 'html' },
  init_options = {
    linters = {
      eslint = {
        command = 'eslint_d',
